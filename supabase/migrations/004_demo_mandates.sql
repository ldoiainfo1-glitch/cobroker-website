-- ============================================================
-- COBROKINGS — Demo Mandates Seed  (v2 — self-contained)
-- Run in: Supabase Dashboard → SQL Editor
-- Safe to re-run: uses fixed UUIDs and ON CONFLICT DO NOTHING.
-- ============================================================

-- ─── Fixed UUIDs used ─────────────────────────────────────────────────────────
--   Demo user/profile : aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa
--   Companies         : 11…1  22…2  33…3  44…4  55…5  66…6  77…7
--   Mandates          : bbbb…01 through bbbb…08
...
VALUES (
  'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
  'demo@cobrokings.in', 'Demo Broker',
...
INSERT INTO mandates (
  ...
  views_count, intro_count, expires_at, posted_by, company_id
) VALUES
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01',
 ...
 'Mumbai', 'Maharashtra', '["Bandra West","Khar West","Santacruz West"]',
 ARRAY['Premium','HNI Client','Ready to Move','Sea View'],
 'active', 420, 8, now() + interval '25 days',
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb07',
 ...
 'Pune', 'Maharashtra', '["Hinjewadi","Wakad","Baner","Balewadi"]',
 ARRAY['Bulk Buy','RERA','Affordable','IT Corridor'],
 'active', 510, 17, now() + interval '15 days',
 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '55555555-5555-5555-5555-555555555555'),

('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb08',
 'Retail Showroom – Pan India Expansion',
 E'Leading fashion retail chain seeking 3,000–6,000 sq.ft ground-floor showroom space in Tier 1 & 2 cities.\n\nBrief:\n- Ground floor with direct street frontage\n- 12-ft clear ceiling height\n- Cities: Delhi, Mumbai, Bengaluru, Hyderabad, Pune, Chennai\n- Lease: 5 years with lock-in\n\nBroker commission: 1 month rent.',
 'lease', 'commercial',
 5000000, 12000000, 3000, 6000, 'sqft',
 'Delhi', 'Delhi', '["Connaught Place","Khan Market","Lajpat Nagar","Karol Bagh"]',
 ARRAY['Retail','Pan India','Fashion','High Street'],
 'active', 760, 19, now() + interval '45 days',
 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '33333333-3333-3333-3333-333333333333')
...
INSERT INTO mandate_images (mandate_id, url, is_primary, sort_order) VALUES
  ...
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 'https://images.unsplash.com/photo-1502005097973-6a7082348e28?w=1200&q=80', false, 1),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1200&q=80',  false, 2),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb02', 'https://images.unsplash.com/photo-1502005097973-6a7082348e28?w=1200&q=80', true,  0),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb02', 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1200&q=80', false, 1),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb02', 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1200&q=80',  false, 2),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb03', 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80', true,  0),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb03', 'https://images.unsplash.com/photo-1497366811353-6870744d04b0?w=1200&q=80', false, 1),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb04', 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1200&q=80', true,  0),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb04', 'https://images.unsplash.com/photo-1553413077-190dd305871c?w=1200&q=80',  false, 1),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb05', 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1200&q=80',  true,  0),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb05', 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80', false, 1),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb06', 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1200&q=80', true,  0),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb06', 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=1200&q=80', false, 1),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb07', 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=1200&q=80', true,  0),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb07', 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1200&q=80',  false, 1),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb08', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&q=80', true,  0),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb08', 'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=1200&q=80', false, 1);

-- ─── 6. Confirm — this SELECT is what you'll see as the result ────────────────
SELECT
  m.title,
  m.mandate_type  AS type,
  m.city,
  m.status,
